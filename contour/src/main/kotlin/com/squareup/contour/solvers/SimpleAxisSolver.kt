...
internal class SimpleAxisSolver(
  ...
  lambda: LayoutContainer.() -> Int
    ...
    AxisSolver, HasLeft, HasRight, WidthOfOnlyContext,
   HasTop, HasBottom, HeightOfOnlyContext {
  ...
  override fun leftTo(
    ...
    p1.point = Point.Min
    p1.mode = mode
    p1.lambda = unwrapLayoutIntLambda(provider)
    return this
  }
  ...
  override fun leftToFloat(
    ...
    p1.point = Point.Min
    p1.mode = mode
    p1.lambda = unwrapFloatLambda(provider)
    return this
  }
  ...
  override fun rightTo(mode: SizeMode, provider: LayoutContainer.() ->Int): AxisSolver {
    p1.point = Point.Max
    p1.mode = mode
    p1.lambda = unwrapLayoutIntLambda(provider)
    return this
  ...
  override fun widthOf(mode: SizeMode, provider: LayoutContainer.() ->Int): AxisSolver {
    size.mode = mode
    size.lambda = unwrapLayoutIntLambda(provider)
    return this
  }
  ...
  override fun widthOfFloat(
    ...
    size.mode = mode
    size.lambda = unwrapFloatLambda(provider)
    return this
  }
